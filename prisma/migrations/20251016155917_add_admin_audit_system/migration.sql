...
-- CreateEnum
CREATE TYPE "SupportTier" AS ENUM ('NONE', 'BASIC', 'FULL');
...
CREATE TABLE "User" (
    ...
    "supportTier" "SupportTier" NOT NULL DEFAULT 'NONE',
...
-- CreateIndex
CREATE INDEX "SupportAccess_supportUserId_organizationId_idx" ON "SupportAccess"("supportUserId", "organizationId");

-- CreateIndex
CREATE INDEX "SupportAccess_expiresAt_idx" ON "SupportAccess"("expiresAt");

-- CreateIndex
CREATE INDEX "SupportAccess_isActive_idx" ON "SupportAccess"("isActive");
...
-- CreateIndex
CREATE INDEX "PatientAccessLog_userId_idx" ON "PatientAccessLog"("userId");

-- CreateIndex
CREATE INDEX "PatientAccessLog_createdAt_idx" ON "PatientAccessLog"("createdAt");

-- CreateIndex
CREATE INDEX "PatientAccessLog_action_idx" ON "PatientAccessLog"("action");
...
-- AddForeignKey
ALTER TABLE "SupportAccess" ADD CONSTRAINT "SupportAccess_supportUserId_fkey" FOREIGN KEY ("supportUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PatientAccessLog" ADD CONSTRAINT "PatientAccessLog_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
