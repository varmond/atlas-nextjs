  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 ovecrflow-y-uto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center px-2 py-1.5 rounded hover:bg[#393c43] text-[#dcddde] cursor-not-allowed">
              <UserCircle className="mr-4 size-8 text-[#b9bbb3]" />
              <span className="font-medium text-sm">Friends</span>
            </div>
            <div className="flex items-center px-2 py-1.5 rounded hover:bg[#393c43] text-[#dcddde] cursor-not-allowed">
              <Inbox className="mr-4 size-8 text-[#b9bbb3]" />
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              ...
              />
              <span className="font-medium">Pepper</span>
            </div>
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex-1">
            <p className="text-small font-medium text-white">You</p>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">Pepper</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-white focus:outline-none px-1 py-2.5 placeholder-[#72767d] cursor-not-allowed"
            />
